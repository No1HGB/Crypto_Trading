...
from backtest_logic import entry_long, close_long, entry_short, close_short
...
for i in range(3, len(df)):
    ...
    e_long = entry_long(df, i)
    c_long = close_long(df, i)
    e_short = entry_short(df, i)
    c_short = close_short(df, i)
